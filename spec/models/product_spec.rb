require 'spec_helper'
 ...
 describe Product do
   it "is valid with a title, description, image url and price" do
   	product = Product.new(
   	title: 'Asus',
   ...
   it "is invalid without image's format (.jpg, .png, .jpeg)" do
      product = Product.new(image_url: 'baitap.pdf')
      product.should_not be_valid
   end
   ...
   it "is invalid with price is a text" do
