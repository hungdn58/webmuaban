    ...
    chatBox = {
        ...
        createChatBox: function (conversation_id, minimizeChatBox) {
            ...
            $("body").append('<div id="chatbox_' + conversation_id + '" class="chatbox"></div>')
             ...
             $.get("conversations/" + conversation_id, function (data) { $('#chatbox_' + conversation_id).html(data); $("#chatbox_" + conversation_id + " .chatboxcontent").scrollTop($("#chatbox_" + conversation_id + " .chatboxcontent")[0].scrollHeight); }, "html");
